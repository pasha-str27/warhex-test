                    ...
                    if (gameObject.tag == "Point")
                    {
                        ...
                        if (playerScore == 10)
                        {
                            ...
                            for (int i = 0; i < PlayerManager.conqueredBases.Count ; ++i)
                                colorChanger.ChangeLineColor(gameObject.transform.position, PlayerManager.conqueredBases[i].transform.position, playerColor);


                            indexForAI = 0;
                        }
                        if (enemyScore == 10 &&!transform.position.Equals(AIManager.finishBase))
                        {
                            ++CurrentMaxIndexAI;
